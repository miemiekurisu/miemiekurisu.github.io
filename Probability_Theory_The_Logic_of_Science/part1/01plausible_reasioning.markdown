...
我们在开头重点强调的是，此处所关注的是 *逻辑* 联系，因为关于推理的一些讨论和应用在未能看到逻辑蕴含和物理因果之间的区别，而已经陷入了严重的错误中。其间区别，在 Simon and Rescher （1996）[^1]中有过相当深入的分析和讨论，他们指出，所有试图将蕴含解释为表达物理因果关系的尝试都会在第二种三段论中因对置[^2]缺失而失败（1.2）。
